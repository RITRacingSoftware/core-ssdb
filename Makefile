...
STM32_LD_FLAGS := $(STM32_COMMON_FLAGS) -static -Wl,--gc-sections -T $(STM32_LD_SCRIPT) -specs=nano.specs -specs=nosys.specs -specs=rdimon.specs -lm
...
.PHONY: spin_test
spin_test: $(OUTNAME).elf $(OUTNAME).bin $(OUTNAME).ihex
